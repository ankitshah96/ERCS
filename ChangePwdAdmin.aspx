<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ChangePwdAdmin.aspx.cs" Inherits="ChangePwdAdmin" %>
  ...
  <div class="site-wrapper-inner">
    <div class="cover-container">
      <div class="masthead clearfix">
       <h3 id="H1"   runat="server" class="masthead-brand">Admin Login</h3>
                <ul class="nav masthead-nav" navbar="fixed">
                  <li class="active">
              <a href=" Adminlogin.aspx" target="_parent">Back</a>
            </li> 
...
<h2 style="color:Black; font-family:Lucida Calligraphy; font-size: xx-large;">
       <asp:Label ID="Label2" runat="server" Font-Bold="True" Font-Size="XX-Large" 
            ForeColor="#FF6600" 
            style="z-index: 1; left: -61px; top: 204px; position: absolute; width: 903px; background-color:#11c420; border:#11c420; color:White; border-radius:20px; height: 30px;" 
...
<p>&nbsp;</p>
            ...
            ControlToValidate="Pass1" ErrorMessage="Password cannot be empty!" 
            ForeColor="Red"            
  ...
  <strong>Password cannot be empty</strong> 
          ...
          <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" 
            ...
            ForeColor="Red" 
            style="z-index: 1; left: -264px; top: 332px; position: absolute; height: 93px; width: 483px" 
  ...
  &nbsp;
            ...
            ErrorMessage="* Password do not match" ForeColor="Red" 
              ...
              style="z-index: 1; left: 499px; top: 333px; position: absolute; width: 318px;"><div class="alert alert-warning" style=" background-color:#d83e17; color:White; border-radius:60px;">
  <strong>Password donot match</strong> 
       ...
       <input  style="position:absolute; top: 335px; left: 246px; width: 216px; height: 41px;" 
              type="password" runat="server" id="Pass1" name="Pass1" 
              placeholder="Enter new Password" />
                   <input  style="position:absolute; top: 399px; left: 244px; width: 216px; height: 41px;" 
              type="password" runat="server" id="Pass2" name="Pass2" 
              placeholder="Re-Enter new Password" />
                <br /><br />
                       <asp:Button ID="Button1" runat="server" BackColor="#4D90FE" Font-Bold="True" 
            ForeColor="White" onclick="Button1_Click" 
            style="z-index: 1; left: 253px; top: 466px; position: absolute; width: 193px; height: 35px; margin-top: 0px" 
            Text="CHANGE PASSWORD" />                  
               <asp:Label ID="Label1" runat="server" 
        style="z-index: 1; left: 6px; top: 205px; position: absolute; width: 679px; margin-top: 0px; height: 80px; background-color:Green;border-radius:60px; font-family:Lucida Calligraphy; font-size:25px;" 
